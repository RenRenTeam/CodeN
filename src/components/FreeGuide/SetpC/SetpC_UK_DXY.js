...
class SetpC_UK_DXY extends React.Component {
    constructor(props) {
        super(props);
    ...
    handleSubmit(e){
        ...
        if(jsonEntity.LanguageType=="选语言成绩类型"||jsonEntity.LanguageType==""||jsonEntity.LanguageType==null){
        ...
        if(jsonEntity.HopeMajor=="选就读专业类型"||jsonEntity.HopeMajor==""||jsonEntity.HopeMajor==null){
        ...
        if(Common.getCookie("userLoginSuccess")!=null&&Common.getCookie("userLoginSuccess").length > 0){
            ...
            Rest.post('/FreeGuideService/InsertFreeGuideForJs',
              ...
              ,function(responseText){
                    ...
                    React.render(<SetpResule result={str} selectArr={studentChoose} Sum={Sum} Country={Country} Type={Type} />, document.getElementById('educationBox'));
                }
            );
        }else{
                        ...
                        <div className="ws-education1">
                            <div className="education-box">
                                <div className="content">
                                    ...
                                    <dl>
                                        <dd>
                                            <Select value={this.state.IMType==null?"选联系方式":this.state.IMType} style={{width:160,height:34}} optionFilterProp="desc"  renderDropdownToBody={true} onChange={this.handleChange.bind(this)}>
                                                <Option value="选联系方式" desc="请选择联系方式">选联系方式</Option>
                                    ...
                                    <dl>
                                        <dd>
                                            <Select value={this.state.AvgScoreType==null?"选成绩类型":this.state.AvgScoreType} style={{width:160,height:34}} optionFilterProp="desc"  renderDropdownToBody={true} onChange={this.handleChangeD.bind(this)}>
                                                <Option value="选成绩类型" desc="选成绩类型">选平均成绩</Option>
                                    ...
                                    <dl>
                                        <dd>
                                            <Select value={this.state.LanguageType==null?"选语言成绩类型":this.state.LanguageType} style={{width:160,height:34}} optionFilterProp="desc"  renderDropdownToBody={true} onChange={this.handleChangeE.bind(this)}>
                                                <Option value="选语言成绩类型" desc="选语言成绩类型">选语言成绩类型</Option>
                                    ...
                                    <dl>
                                        <dd>
                                            <Select value={this.state.HopeMajor==null?"选就读专业类型":this.state.HopeMajor} style={{width:160,height:34}} optionFilterProp="desc"  renderDropdownToBody={true} onChange={this.handleChangeF.bind(this)}>
