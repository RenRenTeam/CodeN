...
class SetpC_AUS_ZX extends React.Component {
    constructor(props) {
        super(props);
    ...
    UserSearchSchool(str,Sum,Country,Type,AreaStr){ 
        ...
        let searchUrl="http://service.shenyuan.org/UniversitySearchNodeJsService/UniversitySearch/Country=AUS;Type=高中;PageIndex=1;PageSize=4;Name=;PlaceArea="+AreaStr          
        $.ajax({
            type: "get",
            url: searchUrl, 
            dataType: "jsonp",
            ...
            if(json){schooolData=json;}
             React.render(<SetpResule result={str} Sum={Sum} selectArr={studentChoose} Country={Country} Type={Type} schoool={schooolData} />, document.getElementById('educationBox'));
    ...
    handleSubmit(e){
        ...
        if(jsonEntity.Area=="选地区"||jsonEntity.Area==""||jsonEntity.Area==null){
            Common.alert("请选择区域！");
            return;
        }
        ...
        if(Common.getCookie("userLoginSuccess")!=null&&Common.getCookie("userLoginSuccess").length > 0){
            ...
            Rest.post('/FreeGuideService/InsertFreeGuideForJs',  
              ...
              ,function(responseText){
                    ...
                    var AreaStr=jsonEntity.Area;
                    self.UserSearchSchool(str,Sum,Country,Type,AreaStr);
                        ...
                        <div className="ws-education1">
                            <div className="education-box">
                                <div className="content">
                                    ...
                                    <dl>                                       
                                        <dd>
                                            <Select value={this.state.Area==null?"选地区":this.state.Area} style={{width:160,height:34}} optionFilterProp="desc"  renderDropdownToBody={true} onChange={this.handleChangeE.bind(this)}>
                                                <Option value="选地区" desc="选地区">选地区</Option>
                                                <Option value="北领地" desc="北领地">北领地</Option>
                                                <Option value="南澳州" desc="南澳州">南澳州</Option>
                                                <Option value="新南威尔士州" desc="新南威尔士州">新南威尔士州</Option>
                                                <Option value="昆士兰州" desc="昆士兰州">昆士兰州</Option>
                                                <Option value="维多利亚州" desc="维多利亚州">维多利亚州</Option>
                                                <Option value="首都" desc="首都">首都</Option>
                                            </Select>
                                        ...
                                        <dd>
                                            <Select value={this.state.SchoolCharacteristics==null?"选学校特色":this.state.SchoolCharacteristics} style={{width:160,height:34}} optionFilterProp="desc"  renderDropdownToBody={true} onChange={this.handleChangeG.bind(this)}>
                                                <Option value="选学校特色" desc="选学校特色">选学校特色</Option>
                                    ...
                                    <dl>
                                        <dd>
                                            <Select value={this.state.AccommodationType==null?"选住宿类型":this.state.AccommodationType} style={{width:160,height:34}} optionFilterProp="desc"  renderDropdownToBody={true} onChange={this.handleChangeH.bind(this)}>
                                                <Option value="选住宿类型" desc="选住宿类型">选住宿类型</Option>
                                        ...
                                        <dd>
                                            <Select value={this.state.TuitionRange==null?"选学费范围":this.state.TuitionRange} style={{width:160,height:34}} optionFilterProp="desc"  renderDropdownToBody={true} onChange={this.handleChangeI.bind(this)}>
                                                <Option value="选学费范围" desc="选学费范围">选学费范围</Option>
