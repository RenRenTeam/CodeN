...
class SetpC_AUS_DX extends React.Component {
    constructor(props) {
        super(props);
    ...
    handleSubmit(e){
        ...
        if(jsonEntity.Major=="选目前专业"||jsonEntity.Major==""||jsonEntity.Major==null){
        ...
        if(Common.getCookie("userLoginSuccess")!=null&&Common.getCookie("userLoginSuccess").length > 0){
            ...
            Rest.post('/FreeGuideService/InsertFreeGuideForJs',
              ...
              ,function(responseText){
                    ...
                    React.render(<SetpResule result={str} Sum={Sum} Country={Country} selectArr={studentChoose} Type={Type} />, document.getElementById('educationBox'));
                }
            );
        }else{
        ...
        // Rest.post('/FreeGuideService/InsertFreeGuideForJs',entity,function(responseText){
        //     alert(responseText);
        // });
                        ...
                        <div className="ws-education1">
                            <div className="education-box">
                                <div className="content">
                                    ...
                                    <dl>
                                        <dd>
                                            <Select value={this.state.Major==null?"选目前专业":this.state.Major} style={{width:160,height:34}} optionFilterProp="desc"  renderDropdownToBody={true} onChange={this.handleChangeC.bind(this)}>
