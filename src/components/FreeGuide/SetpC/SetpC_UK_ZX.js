...
class SetpC_UK_ZX extends React.Component {
    constructor(props) {
        super(props);
    ...
    UserSearchSchool(str,Sum,Country,Type,AreaStr){
        ...
        let searchUrl="http://service.shenyuan.org/UniversitySearchNodeJsService/UniversitySearch/Country=UK;Type=高中;PageIndex=1;PageSize=4;Name=;"+AreaStr;
        ...
        if(Common.getCookie("userLoginSuccess")!=null&&Common.getCookie("userLoginSuccess").length > 0){
            ...
            Rest.post('/FreeGuideService/InsertFreeGuideForJs',
              ...
              ,function(responseText){
                    ...
                    let userSearch="PlaceArea="+jsonEntity.Area+";SchoolNature="+jsonEntity.SchoolNature+";SchoolCharacteristic="+
                                    ...
                                    <dl>
                                          <dd>
                                            <Select value={this.state.SchoolType==null?"选学校类型":this.state.SchoolType} style={{width:180,height:34}} optionFilterProp="desc"  renderDropdownToBody={true} onChange={this.handleChangeB.bind(this)}>
                                                <Option value="选学校类型" desc="选学校类型">选择就读学校类型</Option>
                                    ...
                                    <dl>
                                        <dd>
                                            <Select value={this.state.Area==null?"选地区":this.state.Area} style={{width:160,height:34}} optionFilterProp="desc"  renderDropdownToBody={true} onChange={this.handleChangeE.bind(this)}>
                                                <Option value="选地区" desc="选地区">选择地区</Option>
