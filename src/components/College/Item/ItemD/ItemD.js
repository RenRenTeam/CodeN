...
class ItemD extends React.Component {
                    ...
                    <div className="xuexiao">
                        ...
                        <div className="xuexiao_bot">
                            <div className="xuexiao_bot_left">
                                <a className="eachGetHrefA" target="_blank" href={1 == 1 ? "/CollegeDetail-" + this.props.country + "-" + this.props.school + "-" + this.props.json.UniversitySysno : ""} >
                            ...
                            <div className="xuexiao_bot_right">
                                <div className="xuexiao_bot_right_top">
                                    ...
                                    <div className="bot_right_left">
                                        ...
                                        <div className="left_you">{this.props.json.Area}</div>
                                    </div>
                                </div>
                            </div>
