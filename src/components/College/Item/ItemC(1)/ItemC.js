                    ...
                    <div className="xuexiao">
                        ...
                        <div className="xuexiao_bot">
                            <div className="xuexiao_bot_left">
                                <a className="eachGetHrefA" href={"/CollegeDetail-" + this.props.country + "-" + this.props.school + "-" + this.props.json.Sysno} onClick={Link.handleClick}>
                            ...
                            <div className="xuexiao_bot_right">
                                <div className="xuexiao_bot_right_top">
                                    <div className="bot_right_left" >
                                        <div className="left_zuo like"><img src="http://passport.shenyuan.org/WebResources/Default/images/college/like.png" onClick={this.likePush.bind(this)} /></div>
                                ...
                                <div className="right_bot">
                                    <div className="sc_paiming">
                                        <div className="sc_paiming_left">
                                            <div className="paiming_zuo">国际ccc</div>
