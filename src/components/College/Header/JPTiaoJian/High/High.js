...
class High extends React.Component{
    constructor(props) {
        super(props);
        this.state = {Position:'',Classes:'',MoreFilter:false,MoreArea:false,Exam:"",changeTime:"",EJU:""};
    }
    changeArea(e){
     
        let PositionStr=$(e.target).parent().attr("data-value");
        this.setState({
            Position:PositionStr
        }); 
         this.searchAll("PositionArr",PositionStr);

    }
    changeUniproperty(e){
   
        let ClassesStr=$(e.target).parent().attr("data-value");
        this.setState({
            Classes:ClassesStr
        }); 
        this.searchAll("ClassesArr",ClassesStr);
    ...
    changeTime(e){
        ...
        this.searchAll("changeTimeArr",timeStr);  
    }
    changeEJU(e){
    ...
    changeExam(e){
        ...
        this.searchAll("ExamArr",ExamStr); 
    }
    searchData(){
        ...
        let ResearchmentDepartment=$("#InputResearchmentDepartment").val();
        let SubjectProfessional=$("#InputSubjectProfessional").val();
        ...
        CollegeUtilFunc.UserSearchSchool("JP","大学",1,15,SearchArr,userSearch,"");   
    }
            ...
            <div className="college-filter-box university">
                <div className="college-filter-options" data-group="SubjectProfessional">
                    ...
                    <ul className="college-filter-list">
                        <li className="input">
                            <input data-name="ResearchmentDepartment" id="InputResearchmentDepartment" placeholder="学系" type="text" />
                            <em></em>
                            <input data-name="SubjectProfessional" id="InputSubjectProfessional" placeholder="科目/专业" type="text" />
                            <button type="button" className="button-confirm" onClick={this.searchData.bind(this)}>确定</button>
                        </li>
                    </ul>
                </div>
                <div className={this.state.MoreArea?"college-filter-options more show":"college-filter-options more"} data-group="Position" id="showDiQuDv">
                    <div className="title">所在地区：</div>
                    <ul className="college-filter-list" id="searchAreaJp">
                ...
                <div className="college-filter-options" data-group="Classes">
                    ...
                    <ul className="college-filter-list" id="UnipropertyJp">
                        <li className={this.state.Classes==""?"all active":"all"} data-value=""><a className="nofollow" onClick={this.changeUniproperty.bind(this)}>全部</a></li>
                        <li className={this.state.Classes=="1"?"active":""} data-value="1"><a className="nofollow" onClick={this.changeUniproperty.bind(this)}>国立</a></li>
                        <li className={this.state.Classes=="2"?"active":""} data-value="2"><a className="nofollow" onClick={this.changeUniproperty.bind(this)}>公立</a></li>
                        <li className={this.state.Classes=="3"?"active":""} data-value="3"><a className="nofollow" onClick={this.changeUniproperty.bind(this)}>私立</a></li>
                    </ul>
    ...
    componentDidMount(){
        //
        if(this.props.major){$("#InputSubjectProfessional").val(this.props.major);}
    }
}
