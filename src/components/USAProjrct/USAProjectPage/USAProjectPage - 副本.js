...
class USAProjectPage extends React.Component  {
	static contextTypes = {
	  ...
	  constructor(props) {
                    ...
                    return ( 
                    	<div className="contaniner_Deail">
		                    ...
		                    <div id="tableisHiidee">
		                    	<table className="bigDv" cellspacing="0">
			                              <tr className="tr_tHeader">
			                              	...
			                              	<td className="as_table benke cutelement" >
				                              	<table cellspacing="0" className="noBrder_table">
				                              		<tr>
				                              			<td  className="cutelement">
				                              				本科项目
			                              	...
			                              	<td className="as_table shuoshi cutelement" >
				                              	<table cellspacing="0"  className="noBrder_table">
				                              		<tr>
				                              			<td className="cutelement">
				                              				硕士项目
								...
								<td></td>
								<td className="benke as_table_A"></td>
								<td className="benke smallSiza as_table_B">
								
							</td>
								<td className= "benke as_table_C" ></td>
								<td className= "shuoshi as_table_A"></td>
								<td className= "shuoshi smallSiza as_table_B"></td>
								<td className="shuoshi last_td as_table_C" ></td>
							</tr>
							...
							<tr>
								...
								<td className="benke as_table_C" ></td>
								<td className="shuoshi as_table_A"></td>
								<td className="shuoshi smallSiza as_table_B">预科：GPA3,托福69，雅思6分以上
							证书课程：最低托福83，雅思6.5语言可内测</td>
								<td className="shuoshi last_td as_table_C"></td>
							</tr>
							...
							<tr>
								<td className="xuhao">200+</td>
								<td className="name"><a onClick = {Link.handleClick} href="/CollegeDetail-USA-%E5%A4%A7%E5%AD%A6-24983">费尔雷迪克森大学 <p></p></a></td>
								<td></td>
								<td className="benke as_table_A"></td>
								<td  className="benke smallSiza as_table_B">
		...
		if(flag.length > 1){
			$("#showwTableisshow").hide();
			$("#tableisHiidee").show();
		}else{
			$("#tableisHiidee").hide();
			$("#showwTableisshow").show();
		}
          }
}
