        ...
        return (
            <div id="myInfo" className="tab-content-box">
                    ...
                    <dd>
                        <div className="faceImg_border" >
                            <div className="border_dv">
                                <img id="HeadImgBig" src="http://passport.shenyuan.org/WebResources/Default/images/personal-center/faceImg_default.png" width="89" height="73" />
                            </div>
                        </div>
                ...
                <dl className="info_form clearfix hidepart facePart" data-flag="facePart">
                    ...
                    <dd className="faceRR">
                        <img id="HeadImgSmall" width="52px" height="52px" src="http://passport.shenyuan.org/WebResources/Default/images/personal-center/defaultFace.png" /></dd>
