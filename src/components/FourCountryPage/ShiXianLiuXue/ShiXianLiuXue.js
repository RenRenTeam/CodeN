            ...
            <section className="effect-wish">
                ...
                <div className="content">
                    <ul>
                        ...
                        <li>
                            <img src="http://passport.shenyuan.org/WebResources/Default/images/effect-wish/3.jpg" />
                            <div className="title-box">
                        ...
                        <li>
                            <img src="http://passport.shenyuan.org/WebResources/Default/images/effect-wish/2.jpg" />
                            <div className="title-box">
