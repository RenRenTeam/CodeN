...
import styles from './css/jp.less';
...
class LiuCheng extends React.Component {
		            ...
		            <div className="mainPart">
		                ...
		                <div className="allContent">
		                    ...
		                    <div className="contentDvItem" id="yuyan_toSchool_item4">
		                        <i className="iconArrow"></i>
		                        在日本的生活知识包括日本的货币、电源、电压、交通方式、手机网络办理、垃圾处理知识、银行开户以及国民健康保险等。具体详情请点击<a className="showBigContent" onClick={this.handleAlertA.bind(this)}>这里</a>。
		                    ...
		                    <div className="contentDvItem" id="yuyan_toSchool_item5">
		                        ...
		                        恭喜你已经拿到了赴日签证，到达日本前有一些注意的要点，包括行李要求、常用物品、应急药物等等。具体详情请点击<a className="showBigContent" onClick={this.handleAlertB.bind(this)}>这里</a>。
    ...
    handleAlertA(e){
    	...
    	$("#components_Alert").html("");

    	React.render(<Detail flag="生活知识" /> , document.getElementById('components_Alert'));
    }
    handleAlertB(e){

    	$("#components_Alert").html("");

    	React.render(<Detail flag="行前准备" /> , document.getElementById('components_Alert'));
    }
